...
cargo run -p dryad_benchmark -- all --format markdown --output benchmark_prod.md --iterations 10000

# Executar todos os benchmarks com saída em Markdown e 100000 iterações / para testes de estresse
cargo run -p dryad_benchmark -- all --format markdown --output benchmark_stress.md --iterations 100000
