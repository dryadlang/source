...
pub fn register_utils_functions(functions: &mut HashMap<String, fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>>) {
    functions.insert("native_eval".to_string(), native_eval as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_clone".to_string(), native_clone as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_watch_file".to_string(), native_watch_file as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_random_int".to_string(), native_random_int as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_random_float".to_string(), native_random_float as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    ...
    functions.insert("native_random_seed".to_string(), native_random_seed as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_regex_match".to_string(), native_regex_match as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_regex_replace".to_string(), native_regex_replace as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_regex_split".to_string(), native_regex_split as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
    functions.insert("native_regex_test".to_string(), native_regex_test as fn(&[RuntimeValue]) -> Result<RuntimeValue, RuntimeError>);
}
...
fn native_eval(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_clone(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_watch_file(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_random_int(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_random_float(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_random_seed(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 1 {
...
fn native_regex_match(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_regex_replace(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 3 {
...
fn native_regex_split(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
...
fn native_regex_test(args: &[RuntimeValue]) -> Result<RuntimeValue, RuntimeError> {
    if args.len() != 2 {
