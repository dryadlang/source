---
title: "Sistema de Erros"
description: "Arquitetura de erros, códigos e formatação de diagnósticos."
...
Armazena não apenas coordenadas, mas opcionalmente a _linha de código fonte original_ (`source_line`). Isso permite que o formatador de erro imprima o trecho de código sem precisar reler o arquivo do disco (IO-free error reporting).
